...
public class CoastController
{
    ...
    public CoastController(string sState) {
        positions = new Vector3[] {new Vector3(3.5f, 0.75f, 0), new Vector3(4.5f, 0.75f, 0), new Vector3(5.5f, 0.75f, 0),
                                              new Vector3(6.5f, 0.75f, 0), new Vector3(7.5f, 0.75f, 0), new Vector3(8.5f, 0.75f, 0)};
